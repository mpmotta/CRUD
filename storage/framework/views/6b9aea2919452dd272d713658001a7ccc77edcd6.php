...
<body class="bg-secondary">
    <div class="container-md bg-light">
        ...
        <form action="/atualizar/<?php echo e($contato->uuid); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <?php echo method_field("PUT"); ?> 
        <input type="text" name="nome" class="form-control mt-3 mb-3" 
        value="<?php echo e($contato->nome); ?>">
        <input type="email" name="email" class="form-control mb-3"
        value="<?php echo e($contato->email); ?>">
        <input type="tel" name="telefone" class="form-control mb-3" 
        value="<?php echo e($contato->telefone); ?>">
...
</html><?php /**PATH D:\Laravel\Crud\resources\views/edit.blade.php ENDPATH**/ ?>